 ...
 *
 * 新增院線其餘 9 個座標取自本機保存的 `probe/hk6-cinema.html` cinemaList，
 * 按戲院名稱／地址與 source ID 對照；這 9 筆尚未逐點做 Nominatim 反查。
 * `cineart-17` 例外：改用 OpenStreetMap 的「影藝戲院 Cine-Art House」POI
 * （node 3906386531，Photon 搜尋結果），座標 22.3601423,114.1067897。
 * HK Movie 6 的 22.3600746,114.0720739 與青衣城 2 不符，沒有採用。
 *
 ...
 * 座標修正原因
 *
 * 前 7 條對應上方 41 條抽驗中的人工修正；最後一條記錄新院線
 * `cineart-17` 的 HK Movie 6 座標錯置。保留這張表是為了讓後人能複查：
