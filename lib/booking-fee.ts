 ...
 *       因此只在 BY_CINEMA 覆寫該分店。
 *       ★ 凱都**仍設網上購票**（2026-09-26 用戶貼新寶官方售票頁截圖：
 *         virtual.com.hk，26/09 17:50 仍在賣《我阿爹想旅行》）。
 *         舊註解「分店頁註明目前沒有網上售票」是無官方源頭的二手描述，已證偽刪除。
 *         注意與寶石（lux）區分：寶石才是真的不設網上購票（FEE_NO_ONLINE）。
